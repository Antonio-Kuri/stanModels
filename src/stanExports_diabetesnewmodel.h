...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(1618, 1616, "end", "model_diabetesnewmodel");
    return reader;
}
...
cholesterol_rf(const int& position_rf,
    ...
    try {
        ...
        stan::math::assign(rf_current_year, ((((((constant + ((0.02586 * rf_prev_year) * get_base1(temp, position_rf, "temp", 1))) + (age_diag * stan::math::log(get_base1(temp, 7, "temp", 1)))) + ((0.02586 * ref_first) * get_base1(temp, (position_rf + 31), "temp", 1))) + (asian * (logical_eq(get_base1(temp, 4, "temp", 1), 1) ? 1 : 0 ))) + (african * (logical_eq(get_base1(temp, 4, "temp", 1), 2) ? 1 : 0 ))) + (female * (logical_eq(get_base1(temp, 3, "temp", 1), 1) ? 1 : 0 ))));
        current_statement_begin__ = 344;
        stan::model::assign(temp, 
                    stan::model::cons_list(stan::model::index_uni(position_rf), stan::model::nil_index_list()), 
                    (rf_current_year / 0.02586), 
                    "assigning variable temp");

...
#include "stanExports_diabetesnewmodel.h"

RCPP_MODULE(stan_fit4diabetesnewmodel_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_diabetesnewmodel")
